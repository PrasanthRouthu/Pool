...
public class CustomerLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Firebase.setAndroidContext(CustomerLoginActivity.this);
                        ...
                        .addOnCompleteListener(CustomerLoginActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (!task.isSuccessful()) {
                                    pd.dismiss();
                                    Toast.makeText(CustomerLoginActivity.this, "Registration failed" ,
                ...
                auth.signInWithEmailAndPassword(email, password)
                        .addOnCompleteListener(CustomerLoginActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                if (!task.isSuccessful()) {
                                    pd.dismiss();
                                    Toast.makeText(CustomerLoginActivity.this, "Enter valid details!", Toast.LENGTH_SHORT).show();
                                    return;
                                } else {
                                    Intent intent = new Intent(CustomerLoginActivity.this, CustomerMapsActivity.class);
                                    intent.putExtra("User",User);
