...
public class CustomerMapsActivity extends FragmentActivity implements OnMapReadyCallback, DirectionFinderListener,GoogleApiClient.ConnectionCallbacks,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Firebase.setAndroidContext(CustomerMapsActivity.this);
    ...
    private void send(){
        ...
        firebase.child(User).setValue(driver);
        Intent intent = new Intent(this, CustomerJourney00.class);
    ...
    protected synchronized void buildGoogleApiClient() {
        mGoogleApiClient = new GoogleApiClient.Builder(CustomerMapsActivity.this)
                .addConnectionCallbacks(CustomerMapsActivity.this)
                .addOnConnectionFailedListener(CustomerMapsActivity.this)
    ...
    public void onConnected(Bundle bundle) {
        ...
        if (ContextCompat.checkSelfPermission(CustomerMapsActivity.this,
                Manifest.permission.ACCESS_FINE_LOCATION)
                == PackageManager.PERMISSION_GRANTED) {
            LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient, mLocationRequest, CustomerMapsActivity.this);
        }
    ...
    public boolean checkLocationPermission(){
        if (ContextCompat.checkSelfPermission(CustomerMapsActivity.this,
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(CustomerMapsActivity.this,
                    Manifest.permission.ACCESS_FINE_LOCATION)) {
        ...
        switch (requestCode) {
            case MY_PERMISSIONS_REQUEST_LOCATION: {
                ...
                if (grantResults.length > 0
                    ...
                    Toast.makeText(CustomerMapsActivity.this, "permission denied", Toast.LENGTH_LONG).show();
                }
                return;
            }
    ...
    public void onLocationChanged(android.location.Location location) {
        ...
        if (mGoogleApiClient != null) {
            LocationServices.FusedLocationApi.removeLocationUpdates(mGoogleApiClient, CustomerMapsActivity.this);
        }
