...
public class CustomerMapsActivity extends FragmentActivity implements OnMapReadyCallback,DirectionFinderListener {
    ...
    private void sendRequest() {
        ...
        try {
            new DirectionFinder(CustomerMapsActivity.this, SourceHolder, DestinationHolder).execute();
    ...
    private void send(){
        ...
        String DestinationHolder = etDestination.getText().toString();
        if (SourceHolder.isEmpty()) {
            Toast.makeText(CustomerMapsActivity.this, "Enter Source!", Toast.LENGTH_SHORT).show();
            return;
        }
        if (DestinationHolder.isEmpty()) {
        ...
        customer.setCustomerSource(SourceHolder);
        customer.setCustomerDestination(DestinationHolder);
        firebase.child("Customer").child(User).setValue(customer);
        Intent intent = new Intent(CustomerMapsActivity.this, CustomerJourney0.class);
